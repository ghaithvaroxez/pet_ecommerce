          ...
          children: [
            ...
            appLocal=="ar"?Positioned(
              ...
              child: Container(
                ...
                child: Center(
                  child: AutoSizeText(
                    doctorModel.doctor.doctorStatus=="closed"?"مغلق الان".i18n :"مفتوح الان".i18n,
                    minFontSize: 11,
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          //   height: getProportionateScreenHeight(12),
                          // ),
                          Icon(Icons.info,color: Colors.grey,size: getProportionateScreenHeight(14),),
                          SizedBox(
                            width: getProportionateScreenWidth(10),
                          ),
                          Container(
                        ...
                        builder: (controller) => GestureDetector(
                          ...
                          child: Container(
                            padding: EdgeInsets.only(
                                top: getProportionateScreenHeight(12)),
                            decoration: BoxDecoration(
borderRadius: appLocal=="ar"?BorderRadius.only(topLeft: Radius.circular(12)):BorderRadius.only(topRight: Radius.circular(12)),
