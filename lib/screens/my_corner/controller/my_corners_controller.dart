...
@override
  ...
  addCorner(@required String cornerImage,@required String name,@required String desc,@required List<String> subImages) async
  {
...
try{
  ...
  removeLoading();
    ...
    Get.rawSnackbar(message: "عذرا حدث خطأ ما الرجاء المحاولة مرة أخرى ",backgroundColor: Colors.redAccent);
    Get.back();
    removeLoading();
  }
...
update();
  ...
  deleteCorner(int id)async
  {
    try{
      ...
      if(k){
        Get.rawSnackbar(message: "لقد تم حذف زاويتك بنجاح ",backgroundColor: Colors.green);
        await getCorners();
        removeLoading();
      }
      else{
