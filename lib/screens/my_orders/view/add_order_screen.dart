...
import 'translations/add_order_screen.i18n.dart';
                    ...
                    child: Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Spacer(),
                            Container(height:getProportionateScreenHeight(28),child: AutoSizeText("إضافة طلب".i18n,style: h5_21pt,minFontSize: 8,)),
                            Spacer(),
                            SizedBox(
                              width: getProportionateScreenWidth(24),
                            ),
                                            ...
                                            child: DropdownButtonHideUnderline(
                                              child: DropdownButton(
                                                ...
                                                Container(
                                                  width: getProportionateScreenWidth(110),
                                                  alignment: appLocal=="ar"?Alignment.centerRight:Alignment.centerLeft,
                                                  child: AutoSizeText( typeName,maxLines: 1,minFontSize: 9,),),
                                                elevation: 8,
                                                style: blackText_14pt,
                                                icon: Container(width:getProportionateScreenWidth(8),child: RotatedBox(quarterTurns:90,child: Icon(Icons.arrow_drop_down))),
                                                iconDisabledColor: Colors.black,
                                ...
                                children: [
                                  GestureDetector(
                                      onTap: () async {
                                        ...
                                        {
                                          CoolAlert.show(context: context, type: CoolAlertType.error,text:  "السعر يجب ان يكون موجب".i18n);
                                          return;
                                        }
                                        if(image==null)
                                        {
                                          CoolAlert.show(context: context, type: CoolAlertType.error,text: "الرجاء اضافة صورة للطلب".i18n,);
                                          return;
                                        }
