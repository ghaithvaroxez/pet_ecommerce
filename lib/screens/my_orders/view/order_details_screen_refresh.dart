...
class OrderDetailsScreenWithRefresh extends StatefulWidget {
  ...
  @override
  _OrderDetailsScreenWithRefreshState createState() =>
      _OrderDetailsScreenWithRefreshState();
}

class _OrderDetailsScreenWithRefreshState
    extends State<OrderDetailsScreenWithRefresh> {
  Order order;
  bool loading = true;
  bool error = false;
  ...
  deleteAnswer(int answerId) async {
    ...
    try {
      ...
      if (apiResult.statusCode == 200) {
        ...
        setState(() {});
        Get.rawSnackbar(
            message: " الرجاء المحاولة لاحقا".i18n,
                                ...
                                children: [
                                  ...List<Widget>.generate(
                                      ...
                                      (index) => GestureDetector(
                                            onTap: () {
                                              if (order.answers[index]
                                                      .answeredType ==
                                                  "Store") {
                                                Get.to(StoreDetailsById(order
                                                    .answers[index]
                                                    .answeredStoreId));
                                              } else if (order.answers[index]
                                                      .answeredType ==
                                                  "Doctor") {
                                                Get.to(DoctorDetailsPage(order
                                                    .answers[index]
                                                    .answeredId));
                                              }
                                            },
