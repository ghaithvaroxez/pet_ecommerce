  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      floatingActionButton: GestureDetector(
        onTap: (){
          Get.to(()=>EditOrderScreen(order,myOrdersDetailsController,fetchData));
                                ...
                                child:  Container(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Expanded(child:  Container(alignment: Alignment.center,child: AutoSizeText(order.categoryName,style: body2_14pt,),)),
                                        Expanded(child:  Container(child:  Row(
                                          children: [
                                            Expanded(
                                                flex: 1,
                                                child: Column(
                                                  children: [
                                                    SizedBox(height: 6,),
                                                    Container(                                                  alignment: appLocal=="ar"?Alignment.bottomRight:Alignment.bottomLeft,
                        ...
                        child: Row(
                          children: [
                            ...
                            Column(
                              children: [
                                SizedBox(height: getProportionateScreenHeight(16),),
                                Container(width: getProportionateScreenWidth(220),height: getProportionateScreenHeight(20),
