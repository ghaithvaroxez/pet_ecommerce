...
import 'dart:io';
import '../../../main.dart';
import 'translations/edit_order_screen.i18n.dart';
                    ...
                    child: Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Spacer(),
                            Container(height:getProportionateScreenHeight(28),child: AutoSizeText("تعديل الطلب ".i18n,style: h5_21pt,minFontSize: 8,)),
                            Spacer(),
                            SizedBox(
                              width: getProportionateScreenWidth(24),
                            ),
                                        ...
                                        child: DropdownButtonHideUnderline(
                                          child: DropdownButton(
                                            ...
                                            hint:  Container(
                                              ...
                                              alignment: appLocal=="ar"?Alignment.centerRight:Alignment.centerLeft,
                                              child: AutoSizeText( widget.order.categoryName,maxLines: 1,minFontSize: 9,),),
                                            elevation: 8,
                                            style: blackText_14pt,
                                        ...
                                        child: DropdownButtonHideUnderline(
                                          child: DropdownButton(
                                            ...
                                            hint:  Container(
                                              width: getProportionateScreenWidth(110),
                                              alignment: appLocal=="ar"?Alignment.centerRight:Alignment.centerLeft,
                                              child: AutoSizeText( widget.order.typeName,maxLines: 1,minFontSize: 9,),),
                                            elevation: 8,
                                            style: blackText_14pt,
                                            icon: Container(width:getProportionateScreenWidth(8),child: RotatedBox(quarterTurns:90,child: Icon(Icons.arrow_drop_down))),
                                            iconDisabledColor: Colors.black,
                            ...
                            Expanded(
                                child: Row(
                                  children: [
                                    ...
                                    Text("حيوان".i18n,style: body2_14pt,),
                                  ],
                                )
                            ),
                            ...
                            Expanded(
                                child: Row(
                                  children: [
                                    ...
                                    // SizedBox(width: getProportionateScreenWidth(8),),
                                    Text("بيطري".i18n,style: body2_14pt,),
                                  ],
                                )
                            ),
                          ],
                            ...
                            children: [
                              GestureDetector(
                                  onTap: () async {
                                    ...
                                    {
                                      CoolAlert.show(context: context, type: CoolAlertType.error,text: "الرجاء ملئ كافة الحقول قبل اضافة الطلب".i18n);
                                      return;
                                    }
                                    // if(image==null)
                                    // {
...
if(k)
  {
    Get.rawSnackbar(message: "لقد تم تعديل طلبك بنجاح".i18n,backgroundColor: Colors.green);
  await widget.getData();
  }
else{
  Get.rawSnackbar(message: " الرجاء المحاولة مجدداً".i18n,backgroundColor: Colors.red);
