...
class _EditOrderScreenState extends State<EditOrderScreen> {
  ...
  fetchdata() async {
    ...
    if (widget.order.orderType == "animal")
      animal = 0;
    else
      animal = 1;
    setState(() {
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    border: Border.all(
                                        color: Colors.grey.withOpacity(0.6),
                                        width: 1)),
                                child: widget.order.image == "" ||
                                        widget.order.image == null
                                    ? GestureDetector(
                                        onTap: () async {
                                        ...
                                        onTap: () async {
                                          if (nameController.text == "" ||
                                            ...
                                            CoolAlert.show(
                                                ...
                                                text:
                                                    "الرجاء ملئ كافة الحقول قبل اضافة الطلب"
                                                        .i18n);
                                            return;
                                          }
                                          // if(image==null)
