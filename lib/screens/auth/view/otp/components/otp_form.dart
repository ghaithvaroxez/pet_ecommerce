...
class _OtpFormState extends State<OtpForm> {
  ...
  TextEditingController otpCodeController1 =
  new TextEditingController();
  TextEditingController otpCodeController2 =
  new TextEditingController();
  TextEditingController otpCodeController3 =
  new TextEditingController();
  TextEditingController otpCodeController4 =
  new TextEditingController();
  TextEditingController otpCodeController5 =
  new TextEditingController();
  TextEditingController otpCodeController6 =
  new TextEditingController();
      ...
      child: Column(
        children: [
          ...
          AuthButton(
            ...
            title: "المتابعة",
            ontap: ()  {
              authRequest.signInWithPhoneAuthCredentialWithOtpCode(otpCodeController.text);
            },
          ),
        ],
      ),
