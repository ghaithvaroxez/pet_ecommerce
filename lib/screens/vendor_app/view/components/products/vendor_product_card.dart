...
import 'translations/vendor_product_card.i18n.dart';
class VendorProductCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: (){
        Get.to(ProductDetailsPage(product,true));
      },
      child: Container(
      ...
      children: [
      Container(width:getProportionateScreenWidth(125), alignment:appLocal=="ar"?Alignment.centerRight:Alignment.centerLeft,height: getProportionateScreenHeight(20),child: AutoSizeText(product.name,style: body1_16pt,),),
      Container(width:getProportionateScreenWidth(80), alignment:appLocal!="ar"?Alignment.centerRight:Alignment.centerLeft,padding:EdgeInsets.only(left: getProportionateScreenWidth(3)),height: getProportionateScreenHeight(20),child: AutoSizeText("\$"+product.price.floor().toString(),style: body2_14pt,maxLines: 1,minFontSize: 8,),),
      ],
      ),
      ),
      ...
      width: getProportionateScreenHeight(136),height:getProportionateScreenHeight(22),child: AutoSizeText(product.categoryName,style: body1_16pt,),),
      Spacer(),
      Container(
      height: getProportionateScreenHeight(20),
      child:Row(
      ...
      SizedBox(height: getProportionateScreenHeight(8),),
      Container(padding: EdgeInsets.symmetric(horizontal: getProportionateScreenWidth(8)), alignment:appLocal=="ar"?Alignment.centerRight:Alignment.centerLeft,height: getProportionateScreenHeight(20),child: AutoSizeText(product.body,style: darkGrayText_11pt,),),
      Row(
      children: [
      Spacer(
      ),
      ...
      content: Text(
      'انت على وشك حذف هذا المنتج !'.i18n,
      // textDirection: TextDirection.rtl,
      style: body1_16pt,
      ),
      actions: [
