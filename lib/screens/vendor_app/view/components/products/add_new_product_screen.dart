...
class VendorAppAddNewProduct extends StatefulWidget {
  @override
  _VendorAppAddNewProductState createState() => _VendorAppAddNewProductState();
}

class _VendorAppAddNewProductState extends State<VendorAppAddNewProduct> {
                ...
                children: [
                  GestureDetector(
                      onTap: () {
                        ...
                        vendorProductsController.addNewProduct(Product(name: nameController.text,desc: descriptionController.text,price: priceController.text,img: image,));
                        vendorAppTabController.animateTo(0);
                        vendorAppLabelController.changeIndex(0);
                        vendorProductsController.changeToViewProducts();
                      },
                      child: Container(
