...
import 'translations/add_new_product_screen.i18n.dart';
...
class VendorAppAddProduct extends StatefulWidget {
  ...
  VendorAppAddProduct(this.vendorProductsController);
}
                    ...
                    child: Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Spacer(),
                            Container(height:getProportionateScreenHeight(28),child: AutoSizeText("اضافة منتج جديد".i18n,style: h5_21pt,minFontSize: 8,)),
                            Spacer(),
                            SizedBox(
                              width: getProportionateScreenWidth(24),
                            ),
                                ...
                                children: [
                                  GestureDetector(
                                      onTap: () async {
                                        ...
                                        if(image==null)
                                        {
                                          CoolAlert.show(context: context, type: CoolAlertType.error,text: "الرجاء اضافة صورة للمنتج".i18n);
                                          return;
                                        }
