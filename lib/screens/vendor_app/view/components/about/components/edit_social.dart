              ...
              children: [
                    ...
                    child: Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Spacer(),
                            Container(width:getProportionateScreenWidth(300),alignment:Alignment.center,height:getProportionateScreenHeight(28),child: AutoSizeText("تعديل معلومات التواصل الاجتماعي".i18n,style: h5_21pt,minFontSize: 8,)),
                            Spacer(),
                            SizedBox(
                              width: getProportionateScreenWidth(24),
                            ),
                ...
                Column(
                  children: [
                    ...
                    Container(padding:EdgeInsets.symmetric(horizontal: getProportionateScreenWidth(10)),alignment:Alignment.centerRight,child: AutoSizeText("النوع".i18n,style: body1_16pt,
                      // textDirection: TextDirection.rtl,
                    )),

                    SizedBox(height: getProportionateScreenHeight(5),),Container(
                    ...
                    Container(height:SizeConfig.screenHeight/3,width:SizeConfig.screenWidth,child: Column(children: [
                      Container(padding:EdgeInsets.symmetric(horizontal: getProportionateScreenWidth(10)),alignment:Alignment.centerRight,child: AutoSizeText("الرابط".i18n,style: body1_16pt,
                        // textDirection: TextDirection.rtl,
                      )),
                          ...
                          Expanded(
                            child: GestureDetector(
                                onTap: ()async {
                                  if(widget.link.text=="") {
                                    Get.rawSnackbar(
                                        message: "you don't enter any link");
                                    Get.back();
                                  }
                                  else if(widget.type.text=="") {
                                    Get.rawSnackbar(
                                        message: "you don't enter any type");
                                    Get.back();
                                  }
                                  else {
                                    Get.back();
