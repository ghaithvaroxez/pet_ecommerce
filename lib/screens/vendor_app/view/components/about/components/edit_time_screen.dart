...
//   ];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: SafeArea(
        child: failed?Container(width:getProportionateScreenWidth(410),height:getProportionateScreenHeight(200),child: AutoSizeText(" الرجاء المحاولة مرة اخرى ".i18n,style: body3_18pt,),):loading?LoadingScreen():Column(
          children: [
            Container(
              child: Material(
                elevation: 5,
                ...
                child: Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Spacer(),
                        Container(height:getProportionateScreenHeight(28),child: AutoSizeText("تعديل مواعيد العمل".i18n,style: h5_21pt,minFontSize: 8,)),
                        Spacer(),
                        SizedBox(
                          width: getProportionateScreenWidth(24),
                        ),
            ...
            Row(
              children: [
                ...
                Container(padding:EdgeInsets.symmetric(horizontal: getProportionateScreenWidth(10)),alignment:Alignment.centerRight,child: AutoSizeText("يفتح عند الساعة ".i18n,style: body1_16pt,textDirection: TextDirection.rtl,)),
            ...
            Row(
              children: [
                SizedBox(width: getProportionateScreenWidth(16),),
                Container(padding:EdgeInsets.symmetric(horizontal: getProportionateScreenWidth(10)),alignment:Alignment.centerRight,child: AutoSizeText("يغلق عند الساعة ".i18n,style: body1_16pt,textDirection: TextDirection.rtl,)),
