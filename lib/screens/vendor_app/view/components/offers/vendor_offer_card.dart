                  ...
                  child: Column(
                    children: [
                      ...
                      Row(
                          ...
                          children: [
                            Container(
                              width: getProportionateScreenHeight(75),height:getProportionateScreenHeight(22),child: AutoSizeText(offer.category,style: body1_16pt,),),
                            Spacer(),
                            Expanded(child: Container(height: getProportionateScreenHeight(22),child:Row(
                              children: [
                      ...
                      SizedBox(height: getProportionateScreenHeight(8),),
                      Container(alignment: appLocal=="ar"?Alignment.centerRight:Alignment.centerLeft,height: getProportionateScreenHeight(22),width:getProportionateScreenWidth(320),child: AutoSizeText(offer.desc,style: darkGrayText_11pt,),),
                      Row(
                        children: [
                          Spacer(
                          ),
                                ...
                                Expanded(child: GestureDetector(onTap:(){
                                  showDialog(
                                      ...
                                      builder: ((context) => AlertDialog(
                                        ...
                                        content: Text(
                                          'انت على وشك حذف هذا العرض !'.i18n,
                                          // textDirection: TextDirection.rtl,
                                          style: body1_16pt,
                                        ),
                                        actions: [
