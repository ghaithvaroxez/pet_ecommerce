                      ...
                      child: Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              Spacer(),
                              Container(height:getProportionateScreenHeight(28),child: AutoSizeText("اضافة عرض جديد",style: h5_21pt,minFontSize: 8,)),
                              Spacer(),
                              SizedBox(
                                width: getProportionateScreenWidth(24),
                              ),
                                  ...
                                  children: [
                                    GestureDetector(
                                        onTap: () async {
                                          ...
                                          if(image==null)
                                          {
                                            CoolAlert.show(context: context, type: CoolAlertType.error,text: "الرجاء اضافة صورة للعرض",title: "فشلت العملية",);
                                            return;
                                          }
