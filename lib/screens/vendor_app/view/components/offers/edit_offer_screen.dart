import '../../../../../main.dart';
import 'translation/edit_offer_screen.i18n.dart';
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    border: Border.all(
                                        color: Colors.grey.withOpacity(0.6),
                                        width: 1)),
                                child: widget.storeOffer.image == "" ||
                                        widget.storeOffer.image == null
                                    ? GestureDetector(
                                        onTap: () async {
                                        ...
                                        onTap: () async {
                                          if (nameController.text == "" ||
                                            ...
                                            CoolAlert.show(
                                                ...
                                                text:
                                                    "الرجاء ملئ كافة الحقول قبل اضافة العرض"
                                                        .i18n);
                                            return;
                                          }
                                          // if(image==null)
                                          ...
                                          widget.storeOffer.name =
                                              nameController.text;
                                          widget.storeOffer.desc =
                                              descriptionController.text;
                                          await widget.vendorOffersController
                                              .editOffer(
                                                  widget.storeOffer, newImage);
