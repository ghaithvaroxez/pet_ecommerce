                    ...
                    child: Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Spacer(),
                            Container(height:getProportionateScreenHeight(28),child: AutoSizeText("تعديل العرض ".i18n,style: h5_21pt,minFontSize: 8,)),
                            Spacer(),
                            SizedBox(
                              width: getProportionateScreenWidth(24),
                            ),
                                        ...
                                        child: DropdownButtonHideUnderline(
                                          child: DropdownButton(
                                            ...
                                            hint:  Container(
                                              ...
                                              alignment: appLocal=="ar"?Alignment.centerRight:Alignment.centerLeft,
                                              child: AutoSizeText( widget.storeOffer.category,maxLines: 1,minFontSize: 9,),),
                                            elevation: 8,
                                            style: blackText_14pt,
                                        ...
                                        child: DropdownButtonHideUnderline(
                                          child: DropdownButton(
                                            ...
                                            hint:  Container(
                                              width: getProportionateScreenWidth(110),
                                              alignment: appLocal=="ar"?Alignment.centerRight:Alignment.centerLeft,
                                              child: AutoSizeText(  widget.storeOffer.type,maxLines: 1,minFontSize: 9,),),
                                            elevation: 8,
                                            style: blackText_14pt,
                                            icon: Container(width:getProportionateScreenWidth(8),child: RotatedBox(quarterTurns:90,child: Icon(Icons.arrow_drop_down))),
                                            iconDisabledColor: Colors.black,
