...
//         // &&apiResult2.statusCode == 200
//     ) {
//       var j=jsonDecode(apiResult.body);
//         Stores = AllStores.fromJson(j);
//         type_items=   List<ProductType>.from(
//             j["types"].map((x) => ProductType.fromJson(x)));
//
// for(int i=0;i<Stores.stores.length;i++)
//   {
//     if(Stores.stores[i].type=="store")
//       {
// stores.add(Stores.stores[i]);
//       }else if(Stores.stores[i].type=="barn")
//         {
//           barns.add(Stores.stores[i]);
//
//         }
//     else if(Stores.stores[i].type=="sieve")
//       {
//         sieves.add(Stores.stores[i]);
//       }
//   }
//
//     } else {
...
//                   type_items.length==0?Container(width: 0,height: 0,):Container(
...
//                  Stores.stores.length==0?NoItems(): Expanded(
//                    child: Column(
//                       children: [
//                         stores.length==0?Container(width: 0,height: 0,):Expanded(
//                           child: Column(
//                             children: [
...
//                 Expanded(
//                                 flex: 4,
//                                 child:stores.length==0?NoItems(): ListView.builder(
...
//                           ),
//                         ),
//                         barns.length==0?Container(height: 0,width: 0,):Expanded(
//                           child: Column(
//                             children: [
//                               SizedBox(height: getProportionateScreenHeight(15),),
//                               Container(
...
//                                 margin: EdgeInsets.symmetric(horizontal: getProportionateScreenWidth(24)) ,
//                                 // alignment: Alignment.centerRight,
//                                 child: AutoSizeText("الاسطبلات".i18n,style: body3_18pt,
//                                   // textDirection: TextDirection.rtl,
//                                 ),
//                               ),
//                               SizedBox(height: getProportionateScreenHeight(15),),
//                 Expanded(
//                                 flex: 4,
//                                 child:  barns.length==0?NoItems(): ListView.builder(
//                                   // physics: NeverScrollableScrollPhysics(),
//                                     itemCount:   barns.length,
//                                     itemBuilder: (context, index) => index == 0
//                                         ? Column(
//                                       children: [
//                                         VerticalStoreListCard(store: barns[index],addToFav: ()async{
//                                           bool k=  await addToFavorite( barns[index].id);
//                                           return k;
//                                         },)],
//                                     )
//                                         : VerticalStoreListCard(store: barns[index],addToFav: ()async{
...
//                           ),
//                         ),
//                         sieves.length==0?Container(height: 0,width: 0,):Expanded(
//                           child: Column(
//                             children: [
//                               SizedBox(height: getProportionateScreenHeight(15),),
//                               Container(
...
//                                 margin: EdgeInsets.symmetric(horizontal: getProportionateScreenWidth(24)) ,
//                                 // alignment: Alignment.centerRight,
//                                 child: AutoSizeText("المناحل".i18n,style: body3_18pt,
//                                   // textDirection: TextDirection.rtl,
//                                 ),
//                               ),
//                               SizedBox(height: getProportionateScreenHeight(15),),
//                 Expanded(
//                                 flex: 4,
//                                 child:  sieves.length==0?NoItems(): ListView.builder(
//                                   // physics: NeverScrollableScrollPhysics(),
//                                     itemCount:  sieves. length,
//                                     itemBuilder: (context, index) => index == 0
//                                         ? Column(
//                                       children: [
//                                         VerticalStoreListCard(store: sieves[index],addToFav: ()async{
//                                           bool k=  await addToFavorite( sieves[index].id);
//                                           return k;
//                                         },)],
//                                     )
//                                         : VerticalStoreListCard(store: sieves[index],addToFav: ()async{
                            ...
                            : Expanded(
                                child: Container(
                                  ...
                                  child: ListView.builder(
                                      itemCount: type_items.length,
                                      scrollDirection: Axis.horizontal,
                                      itemBuilder: (context, index) =>
                                          GestureDetector(
                                            onTap: () {
                                              Get.to(CategoryTypeItemsScreen(
                                                  type_items[index].id,
                                                  widget.id));
                                            },
                                            child: Container(
