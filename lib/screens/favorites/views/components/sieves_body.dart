...
import 'package:pets_ecommerce/screens/favorites/model/stores_model.dart';
...
class FavoriteSiviesBody extends StatefulWidget {
  @override
  _FavoriteSiviesBodyState createState() => _FavoriteSiviesBodyState();
}

class _FavoriteSiviesBodyState extends State<FavoriteSiviesBody> {
  bool loading =false;
  ...
  fetchData()async
  {
    ...
    try{
      var url =
      Uri.parse("http://pets.sourcecode-ai.com/api/myFavourites/sieves");
