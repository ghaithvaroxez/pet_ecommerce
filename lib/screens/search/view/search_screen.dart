                              ...
                              children: [
                                ...
                                temp_selected_search_type!=1?Container(height: 0,width: 0,): Column(
                                  children: [
                                   ...
                                   SizedBox(height: getProportionateScreenHeight(25),),
                                   !priceFilter?Container():Directionality(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: selected_search_type==1?! submited?Container():Column(
                                        children: [
                                          Container(margin:EdgeInsets.only( bottom: getProportionateScreenHeight(25)),height: getProportionateScreenHeight(30),alignment:Alignment.centerRight,child: AutoSizeText("المنتجات".i18n,style: body3_21pt_nb,),),
                                        ...
                                        children: [
                                          ...
                                          Container(margin:EdgeInsets.only( bottom: getProportionateScreenHeight(25)),height: getProportionateScreenHeight(30),alignment:Alignment.centerRight,child: AutoSizeText("العروض".i18n,style: body3_21pt_nb,),),
                                          GetBuilder<SearchController>(
                                            init: searchController,
                                            builder:(controller)=> controller.loading?LoadingScreen(): Container(
                                        ...
                                        children: [
                                          Container(margin:EdgeInsets.only( bottom: getProportionateScreenHeight(25)),height: getProportionateScreenHeight(30),alignment:Alignment.centerRight,child: AutoSizeText("المتاجر".i18n,style: body3_21pt_nb,),),
                                          GetBuilder<SearchController>(
                                            init: searchController,
                                            builder:(controller)=> controller.loading?LoadingScreen():Container(
                                        ...
                                        children: [
                                          Container(margin:EdgeInsets.only( bottom: getProportionateScreenHeight(25)),height: getProportionateScreenHeight(30),alignment:Alignment.centerRight,child: AutoSizeText("المناحل".i18n,style: body3_21pt_nb,),),
                                          GetBuilder<SearchController>(
                                            init: searchController,
                                            builder:(controller)=> controller.loading?LoadingScreen():      Container(
                                              height: getProportionateScreenHeight(220),
                                        ...
                                        children: [
                                          Container(margin:EdgeInsets.only( bottom: getProportionateScreenHeight(25)),height: getProportionateScreenHeight(30),alignment:Alignment.centerRight,child: AutoSizeText("الاطباء".i18n,style: body3_21pt_nb,),),
                                          GetBuilder<SearchController>(
                                            init: searchController,
                                            builder:(controller)=> controller.loading?LoadingScreen():Container(
                                        ...
                                        children: [
                                          Container(margin:EdgeInsets.only( bottom: getProportionateScreenHeight(25)),height: getProportionateScreenHeight(30),alignment:Alignment.centerRight,child: AutoSizeText("الأصناف".i18n,style: body3_21pt_nb,),),
                                          GetBuilder<SearchController>(
                                            init: searchController,
                                            builder:(controller)=> controller.loading?LoadingScreen():Container(
                                        ...
                                        GetBuilder<SearchController>(
                                            ...
                                            GetBuilder<SearchController>(
                                              ...
                                              builder:(controller)=>  controller.barns.length==0?Container():Column(
                                                children: [
                                                  Container(margin:EdgeInsets.only( bottom: getProportionateScreenHeight(25)),height: getProportionateScreenHeight(30),alignment:Alignment.centerRight,child: AutoSizeText("الاسطبلات".i18n,style: body3_21pt_nb,),),
                                                 controller.loading?LoadingScreen():Container(
