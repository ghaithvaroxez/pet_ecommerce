...
refresh();
                                              ...
                                              hint: Container(
                                                ...
                                                child: AutoSizeText(temp_selected_search_type ==
                                                    -1
                                                    ? ""
                                                    : search_types[
                                                temp_selected_search_type],maxLines: 1,minFontSize: 9,textDirection: TextDirection.rtl,),
                                              ),
                                              elevation: 8,
                                              style:
                                              blackText_14pt,
...
// alignment: Alignment.center,//appLocal=="ar"?Alignment.centerRight:Alignment.centerLeft,
                child: AutoSizeText( selected_city_name,maxLines: 1,minFontSize: 9,textDirection: appLocal=="ar"?TextDirection.rtl:TextDirection.ltr,),),
                                              elevation: 8,
                                              style:
                                              blackText_14pt,
                                              icon: Container(
                              ...
                              children: [
                                ...
                                temp_selected_search_type!=1?Container(height: 0,width: 0,): Column(
                                  children: [
                                   ...
                                   SizedBox(height: getProportionateScreenHeight(25),),
                                   !priceFilter?Container():SliderTheme(
                                       ...
                                       onChanged: (SfRangeValues value) {
                                         setState(() {
                                           ...
                                           if( value.start< value.end)
                                           {
                                                           ...
                                                           price2 =
                                                               value.end;
                                                           _values = SfRangeValues(price1,price2);
                                                         }
                                                       });
                                       },
                                     ),
...
setState((){
  ...
  switch (selected_search_type)
  {
    case 0:
      ...
      break;
    case 1:
      searchController.searchProducts(textSearchController.text,catId: selected_category_id,typeId: selected_type_id,price1: priceFilter?price1:-1,price2: priceFilter?price2:-1);
      break;
    case 2:
                          ...
                          : serachError
                              ...
                              : Column(
                                  children: [
                                    ...
                                    SizedBox(height: getProportionateScreenHeight(25),),
                                    Container(
                                      margin: appLocal=="ar"?EdgeInsets.only(right: getProportionateScreenWidth(24)):EdgeInsets.only(left: getProportionateScreenWidth(24)),
                                      child: selected_search_type==1?! submited?Container():Column(
                                        children: [
                                          Container(margin:EdgeInsets.only( bottom: getProportionateScreenHeight(25)),height: getProportionateScreenHeight(30),  alignment: appLocal=="ar"?Alignment.centerRight:Alignment.centerLeft,child: AutoSizeText("المنتجات".i18n,style: body3_21pt_nb,),),
                                          GetBuilder<SearchController>(
                                            init: searchController,
                                            builder:(controller)=> controller.loading?LoadingScreen():Container(

                                                child: controller.products.length==0?Center(child: AutoSizeText("لا يوجد عناصر لعرضها ".i18n,style: body1_16pt,),):Container(
                                      ...
                                      ): selected_search_type==2?! submited?Container():Column(
                                        children: [

                                          Container(margin:EdgeInsets.only( bottom: getProportionateScreenHeight(25)),height: getProportionateScreenHeight(30),  alignment: appLocal=="ar"?Alignment.centerRight:Alignment.centerLeft,child: AutoSizeText("العروض".i18n,style: body3_21pt_nb,),),
                                          GetBuilder<SearchController>(
                                            init: searchController,
                                            builder:(controller)=> controller.loading?LoadingScreen(): Container(
                                              height: getProportionateScreenHeight(225),
                                              child: controller.offers.length==0?Center(child: AutoSizeText("لا يوجد عناصر لعرضها ".i18n,style: body1_16pt,),):ListView.builder(
                                                scrollDirection: Axis.horizontal,
                                      ...
                                      ):selected_search_type==3?! submited?Container():Column(
                                        children: [
                                          Container(margin:EdgeInsets.only( bottom: getProportionateScreenHeight(25)),height: getProportionateScreenHeight(30),alignment:appLocal=="ar"?Alignment.centerRight:Alignment.centerLeft,child: AutoSizeText("المتاجر".i18n,style: body3_21pt_nb,),),
                                          GetBuilder<SearchController>(
                                            init: searchController,
                                            builder:(controller)=> controller.loading?LoadingScreen():Container(
                                              height: getProportionateScreenHeight(220),
                                              child: controller.stores.length==0?Center(child: AutoSizeText("لا يوجد عناصر لعرضها ".i18n,
                                                style: body1_16pt,),):ListView.builder(
                                                scrollDirection: Axis.horizontal,
                                      ...
                                      ):selected_search_type==4?! submited?Container():Column(
                                        children: [
                                          Container(margin:EdgeInsets.only( bottom: getProportionateScreenHeight(25)),height: getProportionateScreenHeight(30),  alignment: appLocal=="ar"?Alignment.centerRight:Alignment.centerLeft,child: AutoSizeText("الاسطبلات".i18n,style: body3_21pt_nb,),),
                                          GetBuilder<SearchController>(
                                            init: searchController,
                                            builder:(controller)=> controller.loading?LoadingScreen():Container(
                                              height: getProportionateScreenHeight(220),
                                      ...
                                      ):selected_search_type==5?! submited?Container():Column(
                                        children: [
                                          Container(margin:EdgeInsets.only( bottom: getProportionateScreenHeight(25)),height: getProportionateScreenHeight(30),  alignment: appLocal=="ar"?Alignment.centerRight:Alignment.centerLeft,child: AutoSizeText("المناحل".i18n,style: body3_21pt_nb,),),
                                          GetBuilder<SearchController>(
                                            init: searchController,
                                            builder:(controller)=> controller.loading?LoadingScreen():      Container(
                                              height: getProportionateScreenHeight(220),
                                      ...
                                      ):selected_search_type==6?! submited?Container():Column(
                                        children: [
                                          Container(margin:EdgeInsets.only( bottom: getProportionateScreenHeight(25)),height: getProportionateScreenHeight(30),  alignment: appLocal=="ar"?Alignment.centerRight:Alignment.centerLeft,child: AutoSizeText("الاطباء".i18n,style: body3_21pt_nb,),),
                                          GetBuilder<SearchController>(
                                            init: searchController,
                                            builder:(controller)=> controller.loading?LoadingScreen():Container(
                                                height: getProportionateScreenHeight(230),
                                                child: controller.doctors.length==0?Center(child: AutoSizeText("لا يوجد عناصر لعرضها ".i18n,style: body1_16pt,),):
                                                ListView.builder(
                                                    scrollDirection: Axis.horizontal,
                                      ...
                                      ):selected_search_type==7?! submited?Container():Column(
                                        children: [
                                          Container(margin:EdgeInsets.only( bottom: getProportionateScreenHeight(25)),height: getProportionateScreenHeight(30),  alignment: appLocal=="ar"?Alignment.centerRight:Alignment.centerLeft,child: AutoSizeText("الأصناف".i18n,style: body3_21pt_nb,),),
                                          GetBuilder<SearchController>(
                                            init: searchController,
                                            builder:(controller)=> controller.loading?LoadingScreen():Container(
                                                height: getProportionateScreenHeight(172),
                                                child: controller.categories.length==0?Center(child: AutoSizeText("لا يوجد عناصر لعرضها ".i18n,
                                                  style: body1_16pt,),):
                                                ListView.builder(
                                                    scrollDirection: Axis.horizontal,
                                      ...
                                      ):selected_search_type==0?! submited?Container(): GetBuilder<SearchController>(
                                        init: searchController,
                                        builder:(controller)=>(controller.products.length==0&&
                                            controller.offers.length==0&&
                                            controller.stores.length==0&&
                                            controller.barns.length==0&&
                                            controller.sieves.length==0&&
                                            controller.doctors.length==0&&
                                            controller.categories.length==0
                                         )?controller.loading?Container(height: getProportionateScreenHeight(400),width: getProportionateScreenWidth(390),child: Center(child: CircularProgressIndicator(),),):Container(height: getProportionateScreenHeight(200),width: getProportionateScreenWidth(390),child: Center(child: AutoSizeText("لا يوجد عناصر مطابقة لعرضها ".i18n,
                                          style: body3_18pt,),),): Column(
                                          children: [
                                            GetBuilder<SearchController>(
                                              init: searchController,
                                              builder:(controller)=>  controller.products.length==0?Container(): Column(
                                                children: [
                                                  Container(margin:EdgeInsets.only( bottom: getProportionateScreenHeight(25)),height: getProportionateScreenHeight(30),  alignment: appLocal=="ar"?Alignment.centerRight:Alignment.centerLeft,child: AutoSizeText("المنتجات".i18n,style: body3_21pt_nb,),),
                                                  controller.loading?LoadingScreen():Container(
                                        ...
                                        GetBuilder<SearchController>(
                                            init: searchController,
                                            builder:(controller)=>  controller.offers.length==0?Container(): Column(
                                                children: [
                                            ...
                                            GetBuilder<SearchController>(
                                              init: searchController,
                                              builder:(controller)=>  controller.stores.length==0?Container(): Column(
                                                children: [
                                                  Container(margin:EdgeInsets.only( bottom: getProportionateScreenHeight(25)),height: getProportionateScreenHeight(30),  alignment: appLocal=="ar"?Alignment.centerRight:Alignment.centerLeft,child: AutoSizeText("المتاجر".i18n,style: body3_21pt_nb,),),
                                               controller.loading?LoadingScreen():Container(
                                            ...
                                            GetBuilder<SearchController>(
                                              init: searchController,
                                              builder:(controller)=>  controller.barns.length==0?Container():Column(
                                                children: [
                                                  Container(margin:EdgeInsets.only( bottom: getProportionateScreenHeight(25)),height: getProportionateScreenHeight(30),  alignment: appLocal=="ar"?Alignment.centerRight:Alignment.centerLeft,child: AutoSizeText("الاسطبلات".i18n,style: body3_21pt_nb,),),
                                                 controller.loading?LoadingScreen():Container(
                                            ...
                                            GetBuilder<SearchController>(
                                              init: searchController,
                                              builder:(controller)=>  controller.sieves.length==0?Container(): Column(
                                                children: [
                                                  Container(margin:EdgeInsets.only( bottom: getProportionateScreenHeight(25)),height: getProportionateScreenHeight(30),  alignment: appLocal=="ar"?Alignment.centerRight:Alignment.centerLeft,child: AutoSizeText("المناحل".i18n,style: body3_21pt_nb,),),
                                               controller.loading?LoadingScreen():      Container(
                                            ...
                                            GetBuilder<SearchController>(
                                              init: searchController,
                                              builder:(controller)=>  controller.doctors.length==0?Container():  Column(
                                                children: [
                                                  Container(margin:EdgeInsets.only( bottom: getProportionateScreenHeight(25)),height: getProportionateScreenHeight(30),  alignment: appLocal=="ar"?Alignment.centerRight:Alignment.centerLeft,child: AutoSizeText("الاطباء".i18n,style: body3_21pt_nb,),),
                                                  controller.loading?LoadingScreen():Container(
                                            ...
                                            GetBuilder<SearchController>(
                                              init: searchController,
                                              builder:(controller)=>  controller.categories.length==0?Container():  Column(
                                                children: [
                                                  Container(margin:EdgeInsets.only( bottom: getProportionateScreenHeight(25)),height: getProportionateScreenHeight(30),  alignment: appLocal=="ar"?Alignment.centerRight:Alignment.centerLeft,child: AutoSizeText("الأصناف".i18n,style: body3_21pt_nb,),),
                                                 controller.loading?LoadingScreen():Container(

                                                        child: controller.categories.length==0?Center(child: AutoSizeText("لا يوجد أصناف مطابقة ",style: body1_16pt,),):
                                                        Container(
                                                          ...
                                                          child: ListView.builder(
                                                              ...
                                                              itemCount: controller.categories.length,
                                                              itemBuilder: (context, index) =>
                                                                  Container(margin:EdgeInsets.only(left: 10),child: CategoryCard(controller.categories[index]))
                                                          ),
                                                        )),
