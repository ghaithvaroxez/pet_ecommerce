...
Future<bool> addBarnToFavorite(int storeId) async {
  try {
    consolePrint("store id" + storeId.toString());
    var url = Uri.parse("${Api.baseUrl}/addToFavourite/$storeId/store/barn");
    consolePrint("before add to favorite print");
    final h = await HttpService().getHeaders();
    final apiResult = await http.post(url, headers: h);
    consolePrint("after add to favorite print");
...
Future<bool> addSieveToFavorite(int storeId) async {
  try {
    consolePrint("store id" + storeId.toString());
    var url = Uri.parse("${Api.baseUrl}/addToFavourite/$storeId/store/sieve");
    consolePrint("before add to favorite print");
    final h = await HttpService().getHeaders();
    final apiResult = await http.post(url, headers: h);
    consolePrint("after add to favorite print");
                    ...
                    child: ListView(
                      children: [
                        ...
                        Container(
                          ...
                          child: controller.homeModel.categories.length == 0
                              ? Center(
                                  child: AutoSizeText(
                                    "لا يوجد أصناف لعرضها حالياً".i18n,
                                    style: body1_16pt,
                                  ),
                                )
                              : ListView.builder(
                                        ...
                                        Container(
                                            ...
                                            child:
                                              ...
                                              child: CategorySelectedItem(
                                                name: controller.homeModel
                                                    .categories[index].name,
                                                image: controller.homeModel
                          ...
                          child: Column(
                            children: [
                              ...
                              Container(
                                  ...
                                  child: controller.homeModel.products.length ==
                                          0
                                      ? Center(
                                          child: AutoSizeText(
                                            "لا يوجد منتجات لعرضها حالياً".i18n,
                                            style: body1_16pt,
                                          ),
                                        )
                                      : ListView.builder(
...
// SizedBox(height: 45,),
                        ...
                        Container(
                            ...
                            child: controller.homeModel.status.length != 0
                                ? Center(
                                    child: Container(
                                      width: getProportionateScreenWidth(345),
                                      height: getProportionateScreenHeight(233),
                                      ...
                                      child: Container(
                                        width: getProportionateScreenWidth(345),
                                        height:
                                            getProportionateScreenHeight(233),
                                        child: Swiper(
                                          autoplay: true,
                                          autoplayDelay: 5000,
                                          autoplayDisableOnInteraction: true,
                                          itemBuilder: (BuildContext context,
                                            ...
                                            return GestureDetector(
                                              onTap: () {
                                                ...
                                                Get.to(StatusView(
                                                    controller.homeModel.status,
                                                    index));
                                              },
                                              child: _buildSwiperList(
                                                  controller
                                                      .homeModel.status[index],
                                                  index),
                                            );
                                          },
                                          itemCount: controller
                                              .homeModel.status.length,
                                          // pagination: new SwiperPagination(),
                                          duration: 3000,
                                          // control: new SwiperControl(color: Colors.grey),
                                        ),
...
//               ),
                                ...
                                : Center(
                                    child: AutoSizeText(
                                      "لا يوجد حالات لعرضها حالياً".i18n,
                                      style: body1_16pt,
                                    ),
                                  )),
                          ...
                          child: Column(
                            children: [
                              ...
                              Container(
                                ...
                                child: controller.homeModel.stores.length == 0
                                    ? Center(
                                        child: AutoSizeText(
                                          "لا يوجد متاجر لعرضها حالياً".i18n,
                                          style: body1_16pt,
                                        ),
                                      )
                                    : ListView.builder(
                                        scrollDirection: Axis.horizontal,
                                        itemCount:
                                            controller.homeModel.stores.length,
                                        itemBuilder: (context, index) =>
                                            StoreAndStableCard(
                                                controller.homeModel
                                                    .stores[index], () async {
                                          bool k = await addStoreToFavorite(
                                              controller
                                                  .homeModel.stores[index].id);
                                          setState(() {
                                            if (k)
                                              controller.homeModel.stores[index]
                                                      .favStatus =
                                                  (!controller.homeModel
                                                      .stores[index].favStatus);
                                          });
                          ...
                          child: Column(
                            children: [
                              ...
                              Container(
                                  ...
                                  child: controller.homeModel.doctors.length ==
                                          0
                                      ? Center(
                                          child: AutoSizeText(
                                            "لا يوجد أطباء لعرضها حالياً".i18n,
                                            style: body1_16pt,
                                          ),
                                        )
                                      : ListView.builder(
                                          scrollDirection: Axis.horizontal,
                                          itemCount: controller
                                              .homeModel.doctors.length,
                                          itemBuilder: (context, index) =>
                                              DoctorCard(
                                                  controller
                                                      .homeModel.doctors[index],
                                                  () async {
                                                bool k =
                                                    await addDoctorToFavorite(
                                                        controller.homeModel
                                                            .doctors[index].id);
                                                setState(() {
                                                  if (k)
                          ...
                          child: Column(
                            children: [
                              ...
                              Container(
                                ...
                                child: controller.homeModel.offers.length == 0
                                    ? Center(
                                        child: AutoSizeText(
                                          "لا يوجد عروض حالياً".i18n,
                                          style: body1_16pt,
                                        ),
                                      )
                                    : ListView.builder(
                                        scrollDirection: Axis.horizontal,
                                        itemCount:
                                            controller.homeModel.offers.length,
                                        itemBuilder: (context, index) =>
                                            OfferCard(
                                                controller.homeModel
                                                    .offers[index], () async {
                                          bool k = await addOfferToFavorite(
                                              controller
                                                  .homeModel.offers[index].id);
                                          setState(() {
                                            if (k)
                                              controller.homeModel.offers[index]
                                                      .favStatus =
                                                  (!controller.homeModel
                                                      .offers[index].favStatus);
                                          });
                                          return k;
                                        }),
                                      ),
                        ...
                        Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              Container(
                                height: getProportionateScreenHeight(220),
                                child: controller.homeModel.barns.length == 0
                                    ? Center(
                                        child: AutoSizeText(
                                          "لا يوجد أسطبلات لعرضها حالياً".i18n,
                                          style: body1_16pt,
                                        ),
                                      )
                                    : ListView.builder(
                                        scrollDirection: Axis.horizontal,
                                        itemCount:
                                            controller.homeModel.barns.length,
                                        itemBuilder: (context, index) =>
                                            StoreAndStableCard(
                                                controller.homeModel
                                                    .barns[index], () async {
                                          bool k = await addBarnToFavorite(
                                              controller
                                                  .homeModel.barns[index].id);
                                          setState(() {
                                            if (k)
                                              controller.homeModel.barns[index]
                                                      .favStatus =
                                                  (!controller.homeModel
                                                      .barns[index].favStatus);
                                          });
                                          return k;
                                        }),
                                      ),
                        ...
                        Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              Container(
                                height: getProportionateScreenHeight(220),
                                child: controller.homeModel.sieves.length == 0
                                    ? Center(
                                        child: AutoSizeText(
                                          "لا يوجد مناحل لعرضها حالياً".i18n,
                                          style: body1_16pt,
                                        ),
                                      )
                                    : ListView.builder(
                                        scrollDirection: Axis.horizontal,
                                        itemCount:
                                            controller.homeModel.sieves.length,
                                        itemBuilder: (context, index) =>
                                            StoreAndStableCard(
                                                controller.homeModel
                                                    .sieves[index], () async {
                                          bool k = await addSieveToFavorite(
                                              controller
                                                  .homeModel.sieves[index].id);
                                          setState(() {
                                            if (k)
                                              controller.homeModel.sieves[index]
                                                      .favStatus =
                                                  (!controller.homeModel
                                                      .sieves[index].favStatus);
                                          });
                                          return k;
                                        }),
                                      ),
    ...
    child: ClipRRect(
      ...
      child: item.type == "image"
          ...
          : ClipRRect(
              borderRadius: BorderRadius.circular(8),
              child: ThumbnailImage(
                videoUrl: Api.imagePath + item.image,
                height: getProportionateScreenHeight(160),
                width: getProportionateScreenWidth(220),
                fit: BoxFit.fill,
