  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            borderRadius: appLocal=="en"?BorderRadius.only(
          ...
          child: Row(
            ...
            children: [
              freez?Image.asset("assets/images/home/whatsapp.png"):GestureDetector(onTap: () async {
               ...
               if( await canLaunch(whatsappUrl)) launch(whatsappUrl);
                   else
                {
                  ...
                  Get.rawSnackbar(message: "عذرا لا يوجد رقم هاتف !".i18n,  backgroundColor: Colors.blueGrey.withOpacity(0.8),);
              ...
              freez?Image.asset("assets/images/home/facebook.png"):   GestureDetector(onTap: ()async {
                if(fb==null) {
                  Get.rawSnackbar(
                    message: "عذرا لا يوجد رابط !".i18n,  backgroundColor: Colors.blueGrey.withOpacity(0.8),
                  );
                  return;
                }
      ...
      if (await canLaunch(fb)) {
        ...
        Get.rawSnackbar(message: "عذرا لا يوجد رابط !".i18n,  backgroundColor: Colors.blueGrey.withOpacity(0.8),);
      }
