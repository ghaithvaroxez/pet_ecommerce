                ...
                Column(
                  children: [
                    ...
                    Container(height:SizeConfig.screenHeight/3,width:SizeConfig.screenWidth,child: Column(children: [
                      Container(padding:EdgeInsets.symmetric(horizontal: getProportionateScreenWidth(10)),alignment:Alignment.centerRight,child: AutoSizeText( "الرابط".i18n,style:
                      body1_16pt,
                        // textDirection: TextDirection.rtl,
                      )),
                          ...
                          Expanded(
                            child: GestureDetector(
                                onTap: ()async {
                                  if(widget.link.text=="") {
                                    Get.rawSnackbar(
                                        message: "لم تقم باضافة رابط ".i18n);
                                    Get.back();
                                  }
                                  else if(widget.type.text=="") {
                                    Get.rawSnackbar(
                                        message: "لم تقم باختيار النوع ".i18n);
                                    Get.back();
                                  }
                                  else {
                                    Get.back();
