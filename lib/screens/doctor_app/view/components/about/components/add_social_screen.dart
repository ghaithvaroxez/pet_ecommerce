...
import '../translations/add_social_screen.i18n.dart';
List<String> types=[
  "فيسبوك".i18n,
  "انستغرام".i18n,
  "واتساب".i18n
                    ...
                    child: Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Spacer(),
                            Container(height:getProportionateScreenHeight(28),child: AutoSizeText("اضافة معلومات التواصل الاجتماعي".i18n,style: h5_21pt,minFontSize: 8,)),
                            Spacer(),
                            SizedBox(
                              width: getProportionateScreenWidth(24),
                            ),
                ...
                Container(height:SizeConfig.screenHeight/3,width:SizeConfig.screenWidth,child: Column(children: [
                  ...
                  GestureDetector(
                      onTap: ()async {
                        if(widget.link.text=="") {
                          Get.rawSnackbar(
                              message: "لم تقم باضافة رابط ".i18n,duration: Duration(seconds: 4));
                          // Get.back();
                        } else {
                          Get.back();
                          for(int i=0;i<3;i++)
