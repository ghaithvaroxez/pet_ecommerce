                            ...
                            child: DropdownButtonHideUnderline(
                              child: DropdownButton(
                                ...
                                hint:  Container(
                                  ...
                                  alignment: appLocal=="ar"?Alignment.centerRight:Alignment.centerLeft,
                                  child: AutoSizeText(  controller.doctorModel.doctor.address==null?"":controller.doctorModel.doctor.address,maxLines: 1,minFontSize: 9,),),
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Container(width: getProportionateScreenWidth(250),child: AutoSizeText(controller.doctorModel.doctor.info==null?"اضف معلومات مهنية".i18n:controller.doctorModel.doctor.info,style: darkGrayText_14pt,)),
                    Spacer(),
                    GestureDetector(
                      onTap: (){
                        ...
                        {
                          info.text="";
                          Get.to( ()=>EditInfoScreen(t1: info,title: "اضافة معلومات مهنية".i18n,action: (){print("before editing info");controller.changeInfo(info.text);print("after editing info");},));
                        }
                        else {
                          info.text= controller.doctorModel.doctor.info;
                          Get.to( ()=>EditInfoScreen(t1: info,title: "تعديل المعلومات مهنية".i18n,action: (){print("before editing info");controller.changeInfo(info.text);print("after editing info");},));
                        }
                        ...
                        children: [
                          Container(
                            ...
                            child: Row(
                              children: [
                                SizedBox(width: getProportionateScreenWidth(15),),
                                Expanded(flex:2,child: AutoSizeText("رقم الهاتف".i18n,style: darkGrayText_11pt,maxLines: 1,))  ,
                                Spacer(flex:1,),
                                Expanded(
                                    flex:2,
                                    child:  AutoSizeText(controller.doctorModel.doctor.doctorContacts[i].link,style: darkGrayText_11pt,maxLines: 1,minFontSize: 9,)
