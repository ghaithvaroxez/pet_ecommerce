...
class Doctor {
  ...
  factory Doctor.fromJson(Map<String, dynamic> json) => Doctor(
      ...
      info: json["info"],
      doctorContacts: List<DoctorContact>.from(
          json["doctor_contacts"].map((x) => DoctorContact.fromJson(x))),
      doctorServices: List<DoctorService>.from(
          json["doctor_services"].map((x) => DoctorService.fromJson(x))),
      doctorWorkDays: List<StoreWorksDay>.from(
          json["doctor_works_days"].map((x) => StoreWorksDay.fromJson(x))),
