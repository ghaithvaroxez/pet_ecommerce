...
padding: EdgeInsets.symmetric(horizontal: 3),
                                                child: AutoSizeText(  search_types[selectedType],maxLines: 1,minFontSize: 9,),
                                              ),
                                              elevation: 8,
                                              style:
                                              blackText_14pt,
            ...
            children: [
                  ...
                  child: Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Spacer(),
                          Container(height:getProportionateScreenHeight(28),child: AutoSizeText("الاشعارات".i18n,style: h5_21pt,minFontSize: 8,)),
                          Spacer(),
                          GestureDetector(
                            onTap: (){
              ...
              Expanded(
                child: error?Container(
                  ...
                  child:viewedNotifications.length==0? Container(
                  ...
                  SingleChildScrollView(
                    child: Column(
                      children:List.generate(viewedNotifications.length, (index) => NotificationCard(viewedNotifications[index]),
                    ),
                  ),
                ),
              ),
