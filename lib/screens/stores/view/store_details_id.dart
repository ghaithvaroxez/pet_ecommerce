...
class _StoreDetailsByIdState extends State<StoreDetailsById>
  ...
  fetchData() async {
    ...
    if (apiResult.statusCode == 200) {
      ...
      storeStatus = d["store"]["store_status"];
            ...
            : error
                ? Container(
                    ...
                    child: Container(
                        ...
                        child: AutoSizeText(
                          "حدثت مشكلة الرجاء المحاولة لاحقا",
                          style: body3_18pt,
                        )),
                  )
                ...
                : Stack(
                    children: [
                      Positioned(
                          ...
                          child: Container(
                            child: storeImage == null || storeImage == ""
                                ? Container(
                                    height: getProportionateScreenHeight(400),
                      ...
                      Positioned(
                          ...
                          child: Container(
                            child: Opacity(
                              opacity: storeImage == null || storeImage == ""
                                  ? 0.4
                                  : 1,
                              child: Image.asset(
