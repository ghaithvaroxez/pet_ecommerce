  ...
  child: Image.network(Api.imagePath+storeProdcut.image,fit: BoxFit.fill,),
            ...
            appLocal=="ar"?Positioned(
              ...
              child: Container(
                ...
                child: Center(
                  child: AutoSizeText(
                    "\$"+ storeProdcut.price .floor().toString(),
                    minFontSize: 11,
            ...
            Positioned(top:getProportionateScreenHeight(350),bottom:0,left:0,right:0,child: Container(
              decoration: BoxDecoration(
                borderRadius: BorderRadius.only(
                        ...
                        child: Column(
                          children: [
                            ...
                            Container(
                              ...
                              height: getProportionateScreenHeight(30),
                              width: getProportionateScreenWidth(390),
                              child:                                   Container(child: AutoSizeText("الوصف".i18n,style: body3_18pt,)),
                            ),
                          ],
                        ),
                      ),
