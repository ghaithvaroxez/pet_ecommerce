...
class OfferDetailsPageById extends StatefulWidget {
  int offerId;
  bool store;
  OfferDetailsPageById(this.offerId, {this.store=false});

  @override
  _OfferDetailsPageByIdState createState() => _OfferDetailsPageByIdState();
}

class _OfferDetailsPageByIdState extends State<OfferDetailsPageById> {
 ...
 Offer offer;
  ...
  fetchData()async
  {
    ...
    var url=Uri.parse("${Api.baseUrl}/offer/${widget.offerId}");
                      ...
                      Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            SizedBox(height: getProportionateScreenHeight(15),),
                            Container(width:getProportionateScreenWidth(390),child: AutoSizeText("الوصف".i18n,style: body3_18pt,)),
