      ...
      child: Container(
        ...
        child: Stack(
          children: [
                ...
                child: ClipRRect(
                  ...
                  child: CachedNetworkImage(imageUrl:
                   Api.imagePath+widget.store.image,
                    ...
                    errorWidget: (context,s,x)=>Expanded( child: Container(color:Colors.white,alignment:Alignment.center,child: AutoSizeText("Pets",style: BlueText_16pt_bold,))),
                    fit: BoxFit.fill,
                  ),
                ),
              ),
           ...
           appLocal=="ar"? Positioned(left: getProportionateScreenWidth(4), bottom: getProportionateScreenHeight(4), child: SocialMedia(wa: wa,fb: fb,ins: ins,),):Positioned(right: getProportionateScreenWidth(4), bottom: getProportionateScreenHeight(4), child: SocialMedia(wa: wa,fb: fb,ins: ins,),),
