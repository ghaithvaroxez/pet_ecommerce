  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        ...
        margin: EdgeInsets.only(left: getProportionateScreenWidth(24),right: getProportionateScreenWidth(24),bottom: getProportionateScreenHeight(25)),
        ...
        child: Stack(
          children: [
            ...
            Positioned(
                bottom:0,right:0,child: OpenNow(rightBottom: true,)),///open now
          Positioned(right:getProportionateScreenWidth(171),top:getProportionateScreenHeight(20),bottom:getProportionateScreenHeight(35),child:
          Column(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Container(height: getProportionateScreenHeight(30),width: getProportionateScreenWidth(150),child: AutoSizeText("Pets carnival",style: body3_18pt,),),
              Row(
                children: [
                  Image.asset("assets/images/home/clock_icon.png",height: getProportionateScreenHeight(12),),
                  SizedBox(width: getProportionateScreenWidth(10),),
                  Container(height: getProportionateScreenHeight(20),width: getProportionateScreenWidth(120),child: AutoSizeText("صباحا - 9 مساء",style: body3_18pt,minFontSize: 10,),),
                ],
              ),
              Row(
                ...
                children: [
                 Image.asset("assets/images/home/location_icon.png",height: getProportionateScreenHeight(12),),
                  SizedBox(width: getProportionateScreenWidth(10),),
                  Container(height: getProportionateScreenHeight(18),width: getProportionateScreenWidth(120),child: AutoSizeText(
                    "فلسطين رام الله ",style: body3_18pt,minFontSize: 10,),),
                ],
              ),
            ],
          ),
            ...
            Positioned(left:0,bottom:0,child: SocialMedia()),///social media
          ],
        ),
      ),
    );
