...
if(storeModel.store.email==null)
  {
    Get.rawSnackbar(message: "عذرا المتجر ليس له بريد الكتروني !".i18n,);
    return ;
  }
else {
          ...
          Row(
            ...
            children: [
              ...
              GestureDetector(
                  ...
                  child: Container(height:getProportionateScreenHeight(20),child: AutoSizeText("عرض".i18n+" "+ (more==2?"المزيد".i18n:"اقل".i18n),style: body2_14pt,minFontSize: 8,))),
            ],
          ),
          SizedBox(height: getProportionateScreenHeight(10),),
         currentUserStoreId==storeModel.store.id?Container(): GestureDetector(onTap:()async{
            if( gusetId==146)
            {
              showDialog(
                  context: context,
