      ...
      body: SafeArea(
        child: SingleChildScrollView(
          child: GetBuilder<UserController>(
            init: userController,
            builder:(controller)=>controller.isLoading?Container(height:getProportionateScreenHeight(550),child: LoadingScreen()):
            Column(
              children: [
                Container(
                            ...
                            child: Stack(
                              ...
                              children: [
                                ...
                                Container(
                                    ...
                                    width: getProportionateScreenWidth(143),child:GestureDetector(
                                  onTap: ()async{
                                  ...
                                  child: controller.doctorModel.doctor.image==null||controller.doctorModel.doctor.image==""?Center(
                                      ...
                                      )):Container(decoration: BoxDecoration(shape:BoxShape.circle,image: DecorationImage(image: controller.doctorModel.doctor.image==null? AssetImage("assets/images/drawer/user_img.png"):NetworkImage(Api.imagePath+controller.doctorModel.doctor.image),fit: BoxFit.fill
                                ),
                                ),
                                  ),
                          ),
                                ...
                                Positioned(bottom:getProportionateScreenHeight(-6) ,right:getProportionateScreenWidth(15),child: GestureDetector(
                                    onTap:()async{
                                      final pickedFile = await ImagePicker().getImage(source: ImageSource.gallery);
                                      File imageFile = File(pickedFile.path);
                                      if(pickedFile!=null) {
                                    ...
                                    },child: Container(height:35,width:35,child: Image.asset("assets/images/vendor_app/camera.png"),)))
///change photo
                              ],
...
SizedBox(height: getProportionateScreenHeight(25),),
                ...
                Container(
                  margin: EdgeInsets.symmetric(horizontal: appLocal=="ar"?24:24),
                        ...
                        child: DropdownButtonHideUnderline(
                          child: DropdownButton(
                            ...
                            hint: Container(
                              ...
                              alignment: appLocal=="ar"?Alignment.centerRight:Alignment.centerLeft,
                              child: AutoSizeText(  location,maxLines: 1,minFontSize: 9,),),
...
checkPassword( ans);
                      ...
                      },child: Container(margin:EdgeInsets.symmetric(horizontal: getProportionateScreenWidth(12)),width: getProportionateScreenWidth(390),child: AutoSizeText("هل تريد تغير كلمة المرور ؟".i18n,style: body2_14pt_underlined,),)),
                SizedBox(
